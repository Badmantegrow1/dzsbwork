...
if brick_x <= hole_x and brick_y <= hole_y or brick_x <= hole_y and brick_y <= hole_x or brick_z <= hole_x and brick_y <= hole_y or brick_z <= hole_y and brick_y <= hole_x:
    print("Пройдет курпич")
else:
    print("Не пройдет кирпич")
